...
import manualAssetIcon from '../../assets/icons/manual-asset-wallet-final.svg';
            ...
            <div className={styles.connectVisual}>
              <div className={styles.inputList}>
                {connections.map((connection) => (
                  <span key={connection.label}>
                    <img className={styles.connectionIcon} src={connection.icon} alt="" />
                    {connection.label}
                  </span>
                ))}
              </div>
